...
var PropertyFieldSearchPropertiesPickerHost_1 = require("./PropertyFieldSearchPropertiesPickerHost");
/**
 * @interface
 * Represents a PropertyFieldSearchPropertiesPicker object
 *
 */
var PropertyFieldSearchPropertiesPickerBuilder = /** @class */ (function () {
    /**
     * @function
     * Ctor
     */
    function PropertyFieldSearchPropertiesPickerBuilder(_targetProperty, _properties) {
     ...
     */
    PropertyFieldSearchPropertiesPickerBuilder.prototype.render = function (elem) {
        //Construct the JSX properties
        var element = React.createElement(PropertyFieldSearchPropertiesPickerHost_1.default, {
            label: this.label,
     ...
     */
    PropertyFieldSearchPropertiesPickerBuilder.prototype.dispose = function (elem) {
    };
    return PropertyFieldSearchPropertiesPickerBuilder;
}());
/**
 * @function
 ...
 */
function PropertyFieldSearchPropertiesPicker(targetProperty, properties) {
...
exports.PropertyFieldSearchPropertiesPicker = PropertyFieldSearchPropertiesPicker;
//# sourceMappingURL=PropertyFieldSearchPropertiesPicker.js.map