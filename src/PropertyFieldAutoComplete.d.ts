 ...
 */
export declare function PropertyFieldAutoComplete(targetProperty: string, properties: IPropertyFieldAutoCompleteProps): IPropertyPaneField<IPropertyFieldAutoCompletePropsInternal>;
