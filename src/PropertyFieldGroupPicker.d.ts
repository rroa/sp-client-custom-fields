 ...
 * Group type
 */
export declare enum IGroupType {
    /**
     * SharePoint Group
     */
    SharePoint = 0,
 ...
 */
export declare function PropertyFieldGroupPicker(targetProperty: string, properties: IPropertyFieldGroupPickerProps): IPropertyPaneField<IPropertyFieldGroupPickerPropsInternal>;
