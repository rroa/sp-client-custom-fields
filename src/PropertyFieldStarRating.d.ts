 ...
 */
export declare function PropertyFieldStarRating(targetProperty: string, properties: IPropertyFieldStarRatingProps): IPropertyPaneField<IPropertyFieldStarRatingPropsInternal>;
